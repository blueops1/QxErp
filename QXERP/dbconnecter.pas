...
begin
    ...
    begin
      Main.Form1.ADOConnection1.ConnectionString := 'Provider=SQLOLEDB.1;Integrated Security="";Persist Security Info=False;User ID='+edit2.Text+';Initial Catalog='+edit4.Text+';Data Source='+edit1.Text+';Initial File Name="";Server SPN=""';
