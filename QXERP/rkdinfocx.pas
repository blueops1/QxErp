...
uses
  ...
  ZAbstractDataset, ZStoredProcedure, Grids, Menus;
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        datetimetostring(cxdate1,'yyyy-mm-dd',datetimepicker1.Date);
        datetimetostring(cxdate2,'yyyy-mm-dd',datetimepicker2.Date);
...
procedure TForm70.Execl1Click(Sender: TObject);
begin
  if stringgrid1.RowCount>2 then
    ExportStrGridToExcel([stringgrid1])
  else
    application.MessageBox('列表中没有任何数据！','入库单信息查询提示');
end;
...
procedure TForm70.StringGrid1DblClick(Sender: TObject);
begin
...
procedure TForm70.StringGrid1SelectCell(Sender: TObject; ACol, ARow: Integer;
  var CanSelect: Boolean);
begin
