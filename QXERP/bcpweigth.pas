...
procedure TForm103.Button2Click(Sender: TObject);
begin
//proc_import_newadd_htbpmx_to_bcp_weight
try
      with zStoredProc1 do
      begin
        close;
        StoredProcName:='proc_import_newadd_htbpmx_to_bcp_weight';   //fhtbh,fhtdate,fkhmc,fxsyxm,flxr,flxrdh,fhtzje,ffhjsbz,fmemo
        ParamByName('htbh').Value:=edit1.Text;
        ExecProc;
        application.MessageBox('新增数据导入成功','半成品重量管理提示');
      end;
    except
