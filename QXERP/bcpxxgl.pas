...
type
  TForm11 = class(TForm)
    ...
    procedure ComboBox18KeyDown(Sender: TObject; var Key: Word;
      Shift: TShiftState);
    procedure ComboBox19KeyDown(Sender: TObject; var Key: Word;
      Shift: TShiftState);
    procedure ComboBox20KeyDown(Sender: TObject; var Key: Word;
      Shift: TShiftState);
  private
  ...
  begin
    try
      ...
      begin
        ...
        ParamByName('sscpbh6').Value:=''
        else
        ParamByName('sscpbh6').Value:=SplitString(combobox17.Text,'|');
        if combobox18.Text='' then
        ParamByName('sscpbh7').Value:=''
        else
        ParamByName('sscpbh7').Value:=SplitString(combobox18.Text,'|');
  ...
  begin
    try
      ...
      begin
        ...
        ParamByName('sscpbh6').Value:=SplitString(combobox19.Text,'|');
        if combobox20.Text='' then
        ParamByName('sscpbh7').Value:=''
        else
        ParamByName('sscpbh7').Value:=SplitString(combobox20.Text,'|');
...
procedure TForm11.ComboBox17KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
 if key=13 then
 begin
    if combobox17.Items.Count>0 then
    ...
    try
      ...
      begin
        close;
        StoredProcName:='proc_cx_cmlxk_cpbhandmcandzl_by_cpmc';
        ParamByName('cpmc').Value:=ComboBox17.Text;
        open;
        while not eof do
        begin
          ComboBox17.Items.Add(fields[0].asstring);
          next;
        end;
        //combobox1.DroppedDown:=true;
      end;
...
procedure TForm11.ComboBox18KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
 if key=13 then
 begin
    if combobox18.Items.Count>0 then
    ...
    try
      ...
      begin
        close;
        StoredProcName:='proc_cx_cmlxk_cpbhandmcandzl_by_cpmc';
        ParamByName('cpmc').Value:=ComboBox18.Text;
        open;
        while not eof do
        begin
          ComboBox18.Items.Add(fields[0].asstring);
          next;
        end;
        //combobox1.DroppedDown:=true;
      end;
...
procedure TForm11.ComboBox19KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
 if key=13 then
 begin
    if combobox19.Items.Count>0 then
    ...
    try
      ...
      begin
        close;
        StoredProcName:='proc_cx_cmlxk_cpbhandmcandzl_by_cpmc';
        ParamByName('cpmc').Value:=ComboBox19.Text;
        open;
        while not eof do
        begin
          ComboBox19.Items.Add(fields[0].asstring);
          next;
        end;
        //combobox1.DroppedDown:=true;
      end;
...
procedure TForm11.ComboBox20KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
 if key=13 then
 begin
    if combobox20.Items.Count>0 then
    ...
    try
      ...
      begin
        close;
        StoredProcName:='proc_cx_cmlxk_cpbhandmcandzl_by_cpmc';
        ParamByName('cpmc').Value:=ComboBox20.Text;
        open;
        while not eof do
        begin
          ComboBox20.Items.Add(fields[0].asstring);
          next;
        end;
        //combobox1.DroppedDown:=true;
      end;
