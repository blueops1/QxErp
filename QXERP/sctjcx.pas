...
begin
  ...
  try
    ...
    begin
      close;
      sql.Clear;
      sql.Add('select a.fcpbh,b.fcpmc,b.fcpzl,a.rkzs,a.ckzs from (select fcpbh,sum(frksl) as rkzs,SUM(fcksl) as ckzs from cpcrkmxz where datename(week,fjzdate)=datename(week,'''+datetimetostr(datetimepicker3.Date)+''') and year(fjzdate)=year('''+datetimetostr(datetimepicker3.Date)+''') and fisdel=''N'' group by fcpbh) as a join (select fcpbh,fcpmc,fcpzl from cplxk) as b on a.fcpbh=b.fcpbh');
      open;
      ...
      sql.Clear;
      sql.Add('select ''合计'',''0'',''0'',sum(frksl) as rkzs,SUM(fcksl) as ckzs from cpcrkmxz where datename(week,fjzdate)=datename(week,'''+datetimetostr(datetimepicker3.Date)+''') and year(fjzdate)=year('''+datetimetostr(datetimepicker3.Date)+''') and fisdel=''N''');
      open;
      if not eof then
      begin
        stringgrid3.Cells[0,y]:=fields[0].AsString;
...
begin
  ...
  try
    ...
    begin
      close;
      sql.Clear;
      sql.Add('select a.fcpbh,b.fcpmc,b.fcpzl,a.rkzs,a.ckzs from (select fcpbh,sum(frksl) as rkzs,SUM(fcksl) as ckzs from cpcrkmxz where datename(month,fjzdate)=datename(month,'''+datetimetostr(datetimepicker4.Date)+''') and year(fjzdate)=year('''+datetimetostr(datetimepicker3.Date)+''') and fisdel=''N'' group by fcpbh) as a join (select fcpbh,fcpmc,fcpzl from cplxk) as b on a.fcpbh=b.fcpbh');
      open;
      ...
      sql.Clear;
      sql.Add('select ''合计'',''0'',''0'',sum(frksl) as rkzs,SUM(fcksl) as ckzs from cpcrkmxz where datename(month,fjzdate)=datename(month,'''+datetimetostr(datetimepicker4.Date)+''') and year(fjzdate)=year('''+datetimetostr(datetimepicker4.Date)+''') and fisdel=''N''');
      open;
      if not eof then
      begin
        stringgrid5.Cells[0,y]:=fields[0].AsString;
...
begin
  ...
  try
    ...
    begin
      close;
      sql.Clear;
      sql.Add('select a.fcpbh,b.fcpmc,b.fcpzl,a.rkzs,a.ckzs from (select fcpbh,sum(frksl) as rkzs,SUM(fcksl) as ckzs from cpcrkmxz where datename(year,fjzdate)=datename(year,'''+datetimetostr(datetimepicker5.Date)+''') and year(fjzdate)=year('''+datetimetostr(datetimepicker5.Date)+''') and fisdel=''N'' group by fcpbh) as a join (select fcpbh,fcpmc,fcpzl from cplxk) as b on a.fcpbh=b.fcpbh');
      open;
      ...
      sql.Clear;
      sql.Add('select ''合计'',''0'',''0'',sum(frksl) as rkzs,SUM(fcksl) as ckzs from cpcrkmxz where datename(year,fjzdate)=datename(year,'''+datetimetostr(datetimepicker5.Date)+''') and year(fjzdate)=year('''+datetimetostr(datetimepicker5.Date)+''') and fisdel=''N''');
      open;
      if not eof then
      begin
        stringgrid7.Cells[0,y]:=fields[0].AsString;
...
begin
  ...
  try
    ...
    begin
      close;
      sql.Clear;
      sql.Add('select fcpbh,frksl,fcksl,fjzdate,fmemo from cpcrkmxz where datename(week,fjzdate)=datename(week,'''+datetimetostr(datetimepicker3.Date)+''') and year(fjzdate)=year('''+datetimetostr(datetimepicker3.Date)+''') and fisdel=''N'' and fcpbh='''+strCpbh+'''');
      open;
...
begin
  ...
  try
    ...
    begin
      close;
      sql.Clear;
      sql.Add('select fcpbh,frksl,fcksl,fjzdate,fmemo from cpcrkmxz where datename(month,fjzdate)=datename(month,'''+datetimetostr(datetimepicker4.Date)+''') and year(fjzdate)=year('''+datetimetostr(datetimepicker4.Date)+''') and fisdel=''N'' and fcpbh='''+strCpbh+'''');
      open;
...
begin
  ...
  try
    ...
    begin
      close;
      sql.Clear;
      sql.Add('select fcpbh,frksl,fcksl,fjzdate,fmemo from cpcrkmxz where datename(year,fjzdate)=datename(year,'''+datetimetostr(datetimepicker5.Date)+''') and year(fjzdate)=year('''+datetimetostr(datetimepicker3.Date)+''') and fisdel=''N'' and fcpbh='''+strCpbh+'''');
      open;
