...
var
  ...
  booldouble:boolean;
begin
  if (selARow>0) and (selARow<stringgrid1.RowCount-1) then
  begin
  booldouble:=true;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        stringgrid1.Cells[1,stringgrid1.RowCount-2]:=fields[0].AsString;
        stringgrid1.Cells[2,stringgrid1.RowCount-2]:=fields[1].AsString;
        stringgrid1.Cells[3,stringgrid1.RowCount-2]:=fields[2].AsString;
        stringgrid1.Cells[4,stringgrid1.RowCount-2]:=fields[3].AsString;
